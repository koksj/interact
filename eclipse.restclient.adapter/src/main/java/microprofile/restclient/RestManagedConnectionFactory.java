 ...
 * @version $Revision: $
 */
@ConnectionDefinition(connectionFactory = RestConnectionFactory.class, connectionFactoryImpl = RestConnectionFactoryImpl.class, connection = RestConnection.class, connectionImpl = RestConnectionImpl.class)
public class RestManagedConnectionFactory implements ManagedConnectionFactory, ResourceAdapterAssociation {
	...
	/** The logger */
	private final static Logger logger = Logger.getLogger(RestManagedConnectionFactory.class);
	...
	/** restUrl */
	@ConfigProperty(defaultValue = "http://127.0.0.1:8080")
	...
	/** restUrl */
	@ConfigProperty(defaultValue = "password")
	...
	public int hashCode() {
		int result = 17;
		if (restUrl != null)
			result += 31 * result + 7 * restUrl.hashCode();
		else
			result += 31 * result + 7;
		return result;
	}
	...
	public boolean equals(Object other) {
		...
		if (result) {
			if (restUrl == null)
				result = obj.getRestUrl() == null;
			else
				result = restUrl.equals(obj.getRestUrl());
		}
		return result;
	}
