...
public class RabbitMqManagedConnectionFactory implements ManagedConnectionFactory, ResourceAdapterAssociation {

	/** The serial version UID */
	private static final long serialVersionUID = 1L;

	/** The logger */
	private final static Logger logger = Logger.getLogger(RabbitMqManagedConnectionFactory.class);
	...
	/** rabbitHost */
	@ConfigProperty(defaultValue = "http://127.0.0.1")
	...
	@ConfigProperty(defaultValue = "setThequeueName")
	...
	public ManagedConnection createManagedConnection(Subject subject, ConnectionRequestInfo cxRequestInfo)
		...
		logger.trace("createManagedConnection()");
	...
	public ManagedConnection matchManagedConnections(Set connectionSet, Subject subject,
		...
		logger.trace("matchManagedConnections()");
	...
	public boolean equals(Object other) {
		...
		if (other == this)
			return true;
		if (!(other instanceof RabbitMqManagedConnectionFactory))
			return false;
		boolean result = true;
		RabbitMqManagedConnectionFactory obj = (RabbitMqManagedConnectionFactory) other;
		if (result) {
			if (rabbitHost == null)
