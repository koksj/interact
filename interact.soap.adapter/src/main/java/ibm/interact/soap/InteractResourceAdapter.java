...
/**
 * InteractResourceAdapter
 *
 * @version $Revision: $
 */
@Connector(reauthenticationSupport = false, transactionSupport = TransactionSupport.TransactionSupportLevel.NoTransaction)
public class InteractResourceAdapter implements ResourceAdapter, java.io.Serializable {

	/** The serial version UID */
	private static final long serialVersionUID = 1L;

	/** The logger */
	private final static Logger logger = Logger.getLogger(InteractResourceAdapter.class);

	/**
	 * Default constructor
	 */
	public InteractResourceAdapter() {
	...
	public boolean equals(Object other) {
		...
		if (other == this)
			return true;
		if (!(other instanceof InteractResourceAdapter))
			return false;
		boolean result = true;
		return result;
	}
